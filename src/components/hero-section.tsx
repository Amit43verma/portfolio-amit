    ...
    >
      ...
      <div className="relative z-20 text-center w-full">
        <motion.h1
          ...
          className="text-4xl font-extrabold tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl drop-shadow-lg"
        >
          Hi, I&apos;m <span className="text-primary">{siteConfig.name}</span>
        </motion.h1>
        <motion.div
          variants={itemVariants}
          className="mt-6 mb-10 text-xl text-accent font-semibold sm:text-2xl md:text-3xl h-10 md:h-12 text-center"
        >
          <TypingAnimation 
            texts={heroTexts}
            className="font-bold text-primary typing-glow"
          />
        </motion.div>
        <motion.p
          variants={itemVariants}
          className="mx-auto mt-3 max-w-md text-base text-foreground/80 sm:text-lg md:mt-5 md:max-w-3xl md:text-xl"
        >
        ...
        >
          ...
          <a href="/resume_p.pdf" download={`${siteConfig.name.replace(" ", "_")}_Resume.pdf`}>
            <Button
              variant="outline"
              size="lg"
