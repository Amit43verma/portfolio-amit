      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            ...
            >
              <Card className="flex flex-col overflow-hidden shadow-xl rounded-2xl border border-border bg-card transition-all duration-300 hover:shadow-primary/30 hover:border-primary/70 hover:-translate-y-2">
                <CardHeader className="p-0 relative group">
                  <div className="overflow-hidden rounded-t-2xl">
                    <Image
                      ...
                      width={600}
                      height={400}
                      className="w-full object-cover transition-transform duration-500 group-hover:scale-105 group-hover:brightness-90"
                    />
                    <div className="absolute inset-0 bg-primary/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none rounded-t-2xl" />
                  </div>
                </CardHeader>
